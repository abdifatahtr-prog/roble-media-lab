...
export const metadata: Metadata = { title: "Case Studies", description: "Future Roble Media Lab client success stories, published only when real work and permission are available." };
