    ...
    <>
      ...
      <section className="content-section">
        <div className="shell narrow">
          ...
          <input id="site-search" type="search" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Try “automation” or “content”" style={{ width: "100%", minHeight: 58, border: "1px solid #7d8b98", borderRadius: 14, padding: "0 18px", background: "white", fontSize: 17 }} />
